...
> 🧪 **Hands-on lab:** [Mutable vs Immutable Infrastructure](hands-on-lab/README.md) — deploy one EC2 instance, then watch a tag change go `~` (in-place) and an AMI change go `-/+` (destroy & recreate).
