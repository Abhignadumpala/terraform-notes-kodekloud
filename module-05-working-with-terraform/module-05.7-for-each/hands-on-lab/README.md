...
**Not yet done:** step 4 (removing a name from the *middle* of the set, to rule out "only the first item is special") and step 5 (`terraform destroy` to clean up) — `web-prod-2` and `web-prod-3` are still live in AWS as of this write-up.
