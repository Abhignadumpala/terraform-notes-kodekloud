...
Confirmed independently with the AWS CLI, outside Terraform entirely:
...
- **Verification:** confirmed both ways — `terraform output` and an independent `aws dynamodb scan` via the CLI.
