...
✅ Terraform created the security group: sg-03ee8ffc10cd43d96
✅ Terraform created the EC2 instance: i-077f37d5b08506306
❌ The instance used AWS's default security group instead: sg-0aed90982121d95d8
❌ Terraform didn't warn me — it's valid to have unused resources
How I Caught It
...
Key Lessons
Terraform won't warn you — An unreferenced resource is still valid syntax. It just sits there unused.
The state file is your debugging tool — Cross-check resource IDs in state against what you intended to use.
...
Easy to miss — This happens because Terraform allows partial configurations. AWS then applies defaults (like the default security group), and if you don't inspect the state file, you won't know.
How to Prevent This
